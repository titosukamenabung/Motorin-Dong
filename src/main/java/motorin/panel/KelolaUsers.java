...
//    System.out.println("Panel KelolaUsers dibuat");
    ...
    // KIRIM DATA: Pastikan variabel di EditUser.java bernama 'P' atau sesuaikan
    EU.P = Px; 
    
    EU.setVisible(true);
    refreshData("");  // TODO add your handling code here:
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        DeleteUser DU = new DeleteUser(null, true);
    
    // KIRIM DATA: Agar DeleteUser tahu ID mana yang mau dihapus
    DU.P = Px; 
